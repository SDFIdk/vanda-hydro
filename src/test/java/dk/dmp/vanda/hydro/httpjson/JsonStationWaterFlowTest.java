...
class JsonStationWaterFlowTest {
    @Test
    void testJsonList() throws Exception {
        List<JsonStationResults<JsonMeasurement>> stations;
        try (InputStream is = getClass().getResourceAsStream("water-flow_61000181.json"); Jsonb jsonb = JsonbBuilder.create()) {
            Object dummy = new LinkedList<JsonStationResults<JsonMeasurement>>(){};
